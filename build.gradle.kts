...
//        gradle wrapper --gradle-version 5.6.1 --distribution-type=all
...
dependencies {
    ...
    implementation("org.springframework.cloud:spring-cloud-starter-circuitbreaker-reactor-resilience4j") {
        exclude(group = "io.projectreactor", module = "reactor-test")
    }
...
configurations.all {
    resolutionStrategy.eachDependency {
        ...
        if (requested.name == "spring-cloud-commons") {
            useVersion("2.2.0.BUILD-SNAPSHOT")
        }
        ...
        //}
        //if (requested.name == "reactor-kotlin-extensions") {
        //    useVersion(Versions.reactorKotlinExtensions)
        //}
        //if (requested.name == "spring-boot" || requested.name == "spring-boot-autoconfigure" ||
        //    requested.name == "spring-boot-starter" || requested.name == "spring-boot-starter-aop" ||
        //    requested.name == "spring-boot-starter-logging" || requested.name == "spring-boot-starter-validation") {
        //    useVersion(Versions.springBoot)
        //}
        ...
        //if (requested.name == "spring-messaging" || requested.name == "spring-context-support" ||
        //    requested.name == "spring-webflux" || requested.name == "spring-aop" || requested.name == "spring-beans" ||
        //    requested.name == "spring-context" || requested.name == "spring-core" ||
        //    requested.name == "spring-web" || requested.name == "spring-expression" ||
        //    requested.name == "spring-jcl") {
        //    useVersion(Versions.springBom)
        //}
...
sweeney {
    ...
    enforce(mapOf("type" to "jdk", "expect" to "[12.0.2,14)"))
    validate()
}
                ...
                pom {
                    ...
                    withXml {
                        ...
                        if (dependenciesList.size != 0) {
                            ...
                            val springCloudCommons = dependenciesNode.appendNode("dependency")
                            springCloudCommons.appendNode("groupId", "org.springframework.cloud")
                            springCloudCommons.appendNode("artifactId", "spring-cloud-commons")
                            springCloudCommons.appendNode("version", "2.2.0.BUILD-SNAPSHOT")
                        }
                    }
                }
            }
